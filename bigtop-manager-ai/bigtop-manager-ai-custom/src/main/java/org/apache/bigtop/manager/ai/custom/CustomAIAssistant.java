 ...
 * under the License.
 */
package org.apache.bigtop.manager.ai.custom;
...
public class CustomAIAssistant extends AbstractAIAssistant {

    public CustomAIAssistant(ChatMemory chatMemory, AIAssistant.Service aiServices) {
    ...
    public static class Builder extends AbstractAIAssistant.Builder {
        ...
        public ChatLanguageModel getChatLanguageModel() {
            ...
            String baseUrl = ValidationUtils.ensureNotNull(configProvider.getModel(), "baseUrl");
        ...
        public AIAssistant build() {
            AIAssistant.Service aiService = AiServices.builder(AIAssistant.Service.class)
                    ...
                    .build();
            return new CustomAIAssistant(getChatMemory(), aiService);
        }
    }
}
