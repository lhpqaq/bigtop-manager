...
public class ChatbotController {
    ...
    public ResponseEntity<ChatThreadVO> createChatThreads() {
        return ResponseEntity.success(chatbotService.createChatThreads());
    }
    ...
    public ResponseEntity<ChatThreadVO> updateChatThreads(
        ...
        return ResponseEntity.success(chatbotService.updateChatThreads(chatThreadDTO));
    }

    @Operation(summary = "delete thread", description = "Delete a chat threads")
    @DeleteMapping("/threads/{threadId}")
    public ResponseEntity<Boolean> deleteChatThreads(@PathVariable Long threadId) {
        return ResponseEntity.success(chatbotService.deleteChatThreads(threadId));
    }
